...
# Authors: Joep Tool
#
# Adapted from turtlebot3_gazebo package and Dr. Ilija Hadzic <ih2435@columbia.edu>
...
def generate_launch_description():
    ...
    world = LaunchConfiguration('world', default='room.world')
